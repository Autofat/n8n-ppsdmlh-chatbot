...
(function () {
  ...
  const styles = `
        .n8n-chat-widget {
            ...
            --chat--color-accent: var(--n8n-chat-accent-color, #1d4ed8);
            --chat--color-background: var(--n8n-chat-background-color, #ffffff);
            --chat--color-background-secondary: var(--n8n-chat-background-secondary, #f8fafc);
            --chat--color-font: var(--n8n-chat-font-color, #1e293b);
            --chat--color-font-secondary: var(--n8n-chat-font-secondary, #64748b);
            --chat--color-border: var(--n8n-chat-border-color, #e2e8f0);
            --chat--shadow-primary: 0 20px 25px -5px rgba(37, 99, 235, 0.1), 0 10px 10px -5px rgba(37, 99, 235, 0.04);
            --chat--shadow-hover: 0 25px 50px -12px rgba(37, 99, 235, 0.25);
        ...
        .n8n-chat-widget .welcome-subtitle {
            font-size: 16px;
            color: var(--chat--color-font-secondary);
            margin-bottom: 32px;
            line-height: 1.5;
        }
  ...
  const chatInterfaceHTML = `
        <div class="chat-interface">
            ...
            <div class="chat-input">
                <textarea placeholder="Isi pertanyaan mu disini..." rows="1"></textarea>

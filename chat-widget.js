...
(function () {
  ...
  const styles = `
        ...
        .n8n-chat-widget .chat-container {
            ...
            border-radius: 12px;
            box-shadow: 0 8px 32px rgba(1,86,80,255);
            border: 1px solid rgba(1,86,80,0.2);
            overflow: hidden;
            font-family: inherit;
        }
        ...
        .n8n-chat-widget .chat-message.user {
            ...
            color: white;
            align-self: flex-end;
            box-shadow: 0 4px 12px rgba(1,86,80,255);
            border: none;
        }

        .n8n-chat-widget .chat-message.bot {
            background: var(--chat--color-background);
            border: 1px solid rgba(1,86,80,255);
            color: var(--chat--color-font);
        ...
        .n8n-chat-widget .chat-input {
            padding: 16px;
            background: var(--chat--color-background);
            border-top: 1px solid rgba(1,86,80,255);
            display: flex;
            gap: 8px;
        }
        ...
        .n8n-chat-widget .chat-toggle {
            ...
            border: none;
            cursor: pointer;
            box-shadow: 0 4px 12px rgba(1,86,80,0.3);
            z-index: 999;
            transition: transform 0.3s;
            display: flex;
            align-items: center;
        ...
        .n8n-chat-widget .chat-footer {
            ...
            text-align: center;
            background: var(--chat--color-background);
            border-top: 1px solid rgba(1,86,80,0.1);
        }
